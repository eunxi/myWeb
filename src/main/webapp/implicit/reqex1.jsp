...
요청정보 콘텐트타입 = <%=request.getContentType() %><br></br>
요청정보 프로토콜 = <%=request.getProtocol() %><br></br>
요청정보 전송방식 = <%=request.getMethod() %><br></br>
요청 URL = <%=request.getRequestURL().toString() %><br></br> <!-- StringBuffer 로 반환되기 때문에, String 으로 사용하고 싶을 때 toString() 을 사용해서 변환시켜준다. -->
...
<%
//	String url1 = request.getRequestURL(); // XXX
