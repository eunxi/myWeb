...
<%@page import="tommy.web.memberone.StudentVO"%>
...
<%
	...
	String loginID = (String)session.getAttribute("loginID"); // session 에서 loginID 가져와서 String 으로 변환 후, String loginID 에 넣어주기
	StudentVO vo = dao.getMember(loginID); // dao.getMember(loginID) 넣어서 StudentVO 의 vo 에 넣어주기 -> 하나의 정보가 들어가지는 것
%>
<body>
	<form method="post" name="regForm" action="modifyProc.jsp">
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					<input type="text" name="phone1" size="4" value="<%=vo.getPhone1() %>"/> - <input type="text" name="phone2" size="5" value="<%=vo.getPhone2() %>" /> - <input type="text" name="phone3" size="5" value="<%=vo.getPhone3() %>" />
				</td>
			</tr>
			<tr>
